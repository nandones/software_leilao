 ...
 * so the finals that specifies the Public Key, Private and CPF will be arranged in the code as a comment, 
 * when running this client, it will be necessary to uncomment a set of finals.<br>
